    ...
    <section className="w-full flex justify-center mt-8">
      <div className="w-full max-w-screen-2xl flex lg:flex-row flex-col justify-between lg:h-[55rem]">
        <div className="h-full bg-[rgb(245,245,245)] lg:w-[49%] w-full py-3 pl-8 relative">
          ...
          <div className="text-2xl relative z-10 flex items-center w-fit hover:opacity-100 mb-8 mt-0 opacity-60 cursor-pointer">
            <SiNike className="w-[2rem] h-[2rem] mr-2" /> <span>Nike</span>
          </div>
          <div className="text-2xl relative z-10 w-fit flex items-center hover:opacity-100 my-8 opacity-60 cursor-pointer">
        ...
        <div className="h-full lg:w-[49%] flex flex-col justify-between">
          ...
          <div className="lg:h-[49%] h-full w-full  lg:mt-0 mt-4  bg-[rgb(245,245,245)] py-3 pl-8 relative">
            ...
            <div className="text-2xl z-10 relative flex items-center w-fit hover:opacity-100 mb-4 mt-0 opacity-60 cursor-pointer">
               {t("homepage.product.clothes.blazer")}
            </div>
            <div className="text-2xl z-10 relative flex items-center w-fit hover:opacity-100 mb-4 opacity-60 cursor-pointer">
