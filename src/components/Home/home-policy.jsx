...
const HomePolicy = () => {
  ...
  return (
    <section className="w-full flex lg:justify-center justify-start mt-8">
      <div className="max-w-screen-2xl w-full flex lg:justify-between justify-center lg:flex-row flex-col px-3">
        <div
          className="flex flex-row items-center max-w-[26rem] lg:mb-0 mb-6 relative 
        ...
        <div
          className="flex flex-row items-center max-w-[26rem] relative lg:mb-0 mb-6
                                        before:content before:w-10 before:h-10 
                                        before:bg-[rgb(244,189,98)] before:absolute
                                        before:rounded-[50%] before:z-[-1] before:sm:left-8 before:left-4 before:sm:top-6 before:top-4
                "
        ...
        <div
          className="flex flex-row items-center max-w-[26rem] relative
                                before:content before:w-10 before:h-10 
                                before:bg-[rgb(244,189,98)] before:absolute
                                before:rounded-[50%] before:z-[-1] before:sm:left-8 before:left-4 before:sm:top-6 before:top-4
        "
